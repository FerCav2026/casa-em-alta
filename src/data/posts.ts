...
export const posts: Post[] = [
  ...
  },
  {
    ...
    resumo: 'Microondas com grill: já usei os dois tipos e te conto quando o grill faz diferença real e quando é dinheiro jogado fora. Comparativo honesto com modelos e preços.',
    tempo: '7 min de leitura',
  ...
  },
  {
    ...
    titulo: 'Aspirador Robô Agratto é Bom? O Que Dizem as Avaliações Reais',
    resumo: 'Aspirador robô Agratto é bom mesmo? Reunimos avaliações reais de compradores (nota 4,7 de 5, 261 avaliações) para mostrar o que ele entrega de verdade e onde decepciona.',
    tempo: '7 min de leitura',
  ...
  },
  {
    ...
    tempo: '8 min de leitura',
    imagem: '/images/dolce-gusto-nespresso/capa-dolce-gusto-genio-s-basic-review.webp',
    categoria: 'reviews',
    categoriaLabel: 'Review',
    categoriaColor: 'bg-orange-100 text-orange-700',
  },
  {
    ...
    titulo: 'Os 5 Melhores Aspiradores Verticais Sem Fio de 2026',
    resumo: 'Comparamos 5 aspiradores verticais sem fio vendidos no Brasil: autonomia, filtro HEPA, reservatório e ficha técnica para você escolher sem errar.',
    tempo: '10 min de leitura',
